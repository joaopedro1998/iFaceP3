...
public class Menu {
	...
	public int type() {
		System.out.println("Qual o tipo da conta que voce gostaria de criar?");
		System.out.println("[1]Gratis (nao pode criar comunidades)");
		System.out.println("[2]5 reais por mes (com o direito de criar comunidade)");
		
		return input.nextInt();
	}
	
	public int insidePremium()
	{
